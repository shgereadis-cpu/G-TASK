        ...
        with app.app_context():
            ...
            if text == '/start' or text == '/help':
                if not user:
                    ...
                    if user:
                        message_text = f"ክቡር/ት {user.username}!\n\n" \
                                      f"እንኳን ወደዚህ ታላቅ የገቢ ማዕከል በሰላም መጡ! የእርስዎ የቴሌግራም አካውንት አሁን ወደ ትጋት እና ዕድል ማዕከል ተቀይሯል።\n\n" \
                                      f"<b>✅ ሥራ ይውሰዱ:</b> የአሁኑን ሥራ ዝርዝር ይመልከቱ እና ወዲያውኑ ይጀምሩ።\n\n" \
                                      f"<b>💰 በፍጥነት ይክፈሉ:</b> እያንዳንዱ በተሳካ ሁኔታ የተጠናቀቀ ስራ ብር 10 ያስገኝልዎታል።\n\n" \
                                      f"<b>📅 ዕለታዊ ገቢ:</b> የዕለታዊ ሪዋርድዎን በመውሰድ (Daily Check-in) ቀጣይነት ያለው ገቢዎን ያረጋግጡ።\n\n" \
                                      f"💪 እኛ የእርስዎን ጥረት እናደንቃለን። አብረን እንሥራ!"
                    else:
                ...
                message_text = f"<b>📚 ሀልፕ እና ጥያቄዎች</b>\n\n" \
                              f"<b>ሥራ እንዴት ይሰራልሙ?</b>\n" \
                              f"✅ 'ስራ ይውሰዱ' ተወስደው ጂሜል ስም እና ይለፍ ቃል ይቀበሉ\n" \
                              f"✅ ወደ Gmail.com ሂዱ እና አካውንት ይፍጠሩ\n" \
                              f"✅ ስክሪንሾት ይላኩ ወደ ቦትናው\n" \
                              f"✅ ወደ ቦት ይመለሱ ሰራተኞ አስተውለዋል\n\n" \
                              f"<b>ክፍያ</b>\n" \
                              f"💰 በተለይ ስራ: ብር 10.00\n" \
                              f"💰 ዕለታዊ ሪዋርድ: ብር 0.20\n" \
                              f"💰 ዝቅተኛ ወጣ ውጤት: ብር 40.00\n\n" \
                              f"<b>የሚገቡ ትዕዛዞች</b>\n" \
                              f"/start - ስራ ይጀምሩ\n" \
                              f"/balance - ገንዘብ ሁኔታ\n" \
                              f"/tasks - የሥራ ሁኔታ\n" \
                              f"/help - ይህ ሀልፕ\n\n" \
                              f"🔐 <a href='https://g-task.onrender.com/telegram_auto_login/{generate_telegram_login_token(user) if user else ""}'>ወደ ዌብሳይት ይሂዱ</a>"
